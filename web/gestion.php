	...
	<div class='bloc'>
		...
		<?PHP
			...
			if($res){
				...
				while($row=mysqli_fetch_array($res)){
					echo "<tr><td><a href='manegeadm.php?$row[0]' target='_blank'>$row[0]</a></td></tr>";
				}
				echo "</table>";
			}
		?>
	...
	<div class='bloc'>
		...
		<?PHP
			...
			if($res){
				echo "<table border=2px>";
				while($row=mysqli_fetch_array($res)){
					echo "<tr><td>$row[0]</td><td><a href='boutiqueadm.php?$row[0]' target='_blank'>$row[1]</a></td></tr>";
				}
				echo "</table>";
			}
		?>
	...
	<div class='bloc'>
		...
		<?PHP
			...
			if($res){
				echo "<table border=2px>";
				while($row=mysqli_fetch_array($res)){
					echo "<tr><td>$row[0]</td><td><a href='atelieradm.php?$row[0]' target='_blank'>$row[1]</a></td></tr>";
				}
				echo "</table>";
			}
		?>
